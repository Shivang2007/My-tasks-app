...
android.presplash_color = #F44AE9
...
# (list) Permissions
android.permissions = READ_SMS, READ_EXTERNAL_STORAGE,MANAGE_EXTERNAL_STORAGE,SET_WALLPAPER
...
#
#buildozer --profile demo android debugdebug